...
public class Main extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTextureView = (TextureView) findViewById(R.id.main_textureview);
        assert mTextureView != null;
        mTextureView.setSurfaceTextureListener(mSurfaceTextureListener);

        mCaptureButton = (ImageButton) findViewById(R.id.main_capturebutton);
        mCaptureButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                printToConsole("OnClickCapture");
                takePicture();
            }
        });
    }
    ...
    private void openCamera(int width, int height) {
        ...
        try {
            ...
            for (Size size : sizes) {
                System.out.print("MyCamApp:");
                System.out.print(size.toString());
                System.out.print(" -> ");
                System.out.println(mTextureView.getWidth() + "x" + mTextureView.getHeight());
            }
        ...
        public void run() {
            ...
            try {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(getApplicationContext(), mFile.getAbsolutePath(), Toast.LENGTH_SHORT).show();
                    }
                });
            } catch (IOException e) {
                e.printStackTrace();
    ...
    private void printToConsole(String toConsole) {
        System.out.println("#LOG# -> " + toConsole);
    }
}
